  ...
  return (
    <form action={action} className="flex flex-col gap-6 max-w-xl mx-auto w-full">
      ...
      <div className="flex flex-col gap-1">
        ...
        <input id="title" name="title" type="text" className="border border-(--main-purple) rounded-lg h-12 px-3" />
      ...
      <div className="flex flex-col gap-1">
        ...
        <textarea id="content" name="content" rows={8} className="border border-(--main-purple) rounded-lg px-3 py-2 resize-none" />
